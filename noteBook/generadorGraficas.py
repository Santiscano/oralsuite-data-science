...
dataFrameOralsuite = pd.read_csv('C:/Users/mrodr/OneDrive/Escritorio/TECNICA PROGRAMACION/Personal/Oral_suite_pyton/data/json_oralsuit_csv.csv')

#1. ¿Cuál es el número total de órdenes de trabajo recibidas en un período determinado (por ejemplo, mensual, trimestral, anual)?

def graficar_ordenes_trabajo_por_periodo(dataFrame, periodo='M'):
    ...
    sns.barplot(x='periodo', y='numero_ordenes', data=ordenes_por_periodo)
    plt.title('Número de órdenes de trabajo por período')
    plt.xlabel('Período')
...
if __name__ == "__main__":
    graficar_ordenes_trabajo_por_periodo(dataFrameOralsuite, periodo='M')
